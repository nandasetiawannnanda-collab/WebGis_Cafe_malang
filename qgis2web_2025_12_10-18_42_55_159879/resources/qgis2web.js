...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [112.568947, -8.051575, 112.693771, -7.910847],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([112.441171, -8.111693, 112.778121, -7.843061], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Point_Persebaran_Cafe_Malang_3,
    colName: 'Nama_Cafe',
    zoom: 10,
    collapsed: true,
    map: map,
